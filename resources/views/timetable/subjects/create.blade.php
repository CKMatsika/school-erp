<!-- resources/views/timetable/subjects/create.blade.php -->
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('timetables.subjects.store') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex">
                                    <input type="color" name="color_code" id="color_code" value="{{ old('color_code', '#3490dc') }}"
                                    ...
                                    <input type="text" id="color_text" value="{{ old('color_code', '#3490dc') }}" 
