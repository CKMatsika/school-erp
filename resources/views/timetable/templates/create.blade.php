<!-- resources/views/timetable/templates/create.blade.php -->
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create New Timetable Template') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('timetables.templates.store') }}" method="POST">
                        @csrf
                            ...
                            <div>
                                ...
                                <div class="mt-1 space-y-2">
                                    @php
                                        ...
                                        $oldDays = old('days_of_week', [1, 2, 3, 4, 5]); // Default to weekdays
                                    @endphp
