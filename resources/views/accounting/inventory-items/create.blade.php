        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('accounting.inventory-items.store') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="unit_of_measure" class="block mt-1 w-full" type="text" name="unit_of_measure" :value="old('unit_of_measure')" placeholder="e.g. kg, pcs, box" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="current_stock" class="block mt-1 w-full" type="number" name="current_stock" :value="old('current_stock', 0)" step="0.01" min="0" />
                                    <x-input-error :messages="$errors->get('current_stock')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="reorder_level" :value="__('Reorder Level')" />
                                    <x-text-input id="reorder_level" class="block mt-1 w-full" type="number" name="reorder_level" :value="old('reorder_level', 0)" step="0.01" min="0" />
                                    <x-input-error :messages="$errors->get('reorder_level')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="reorder_quantity" :value="__('Reorder Quantity')" />
                                    <x-text-input id="reorder_quantity" class="block mt-1 w-full" type="number" name="reorder_quantity" :value="old('reorder_quantity', 0)" step="0.01" min="0" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="unit_cost" class="block mt-1 w-full" type="number" name="unit_cost" :value="old('unit_cost', 0)" step="0.01" min="0" />
                                    <x-input-error :messages="$errors->get('unit_cost')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="tax_rate" :value="__('Tax Rate (%)')" />
                                    <x-text-input id="tax_rate" class="block mt-1 w-full" type="number" name="tax_rate" :value="old('tax_rate', 0)" step="0.01" min="0" />
