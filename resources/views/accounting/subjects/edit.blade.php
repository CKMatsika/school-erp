{{-- resources/views/accounting/subjects/edit.blade.php --}}
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('accounting.subjects.update', $subject) }}">
                     @method('PUT') {{-- Important for updates --}}
                     <div class="p-6 bg-white border-b border-gray-200 space-y-6">
                        {{-- Pass the existing subject model to the form partial --}}
                        @include('accounting.subjects._form', ['subject' => $subject])
                    </div>
