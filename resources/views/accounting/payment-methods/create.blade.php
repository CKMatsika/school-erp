        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('accounting.payment-methods.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="code" type="text" name="code" :value="old('code')" class="mt-1 block w-full" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="display_order" type="number" name="display_order" :value="old('display_order')" min="1" class="mt-1 block w-full" />
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="requires_reference" name="requires_reference" type="checkbox" value="1" {{ old('requires_reference') ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="instructions" name="instructions" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('instructions') }}</textarea>
