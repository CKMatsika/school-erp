                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($contacts as $contact)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="ml-4">
                                                    ...
                                                    <div class="text-sm text-gray-500">{{ $contact->student ? 'Student ID: ' . $contact->student->id : '' }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ number_format($contact->getBalance(), 2) }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">
