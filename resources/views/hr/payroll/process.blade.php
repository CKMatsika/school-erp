        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                {{-- Ensure controller passes $staffGroups --}}
                 <form method="POST" action="{{ route('hr.payroll.process.run') }}" onsubmit="this.querySelector('button[type=submit]').disabled=true; this.querySelector('button[type=submit]').innerText='Processing...'; return confirm('Are you sure you want to process payroll for the selected period/group? This action cannot be easily undone.');">
                    @csrf
